...
const ToastBox = ({ type = "none", message = "none" }: any) => {
    return (
        <motion.div initial={{ y: "-50vh" }} exit={{ y: "-50vh" }} animate={{ y: 0 }} transition={{ duration: 0.5 }} className="fixed top-0 right-0 w-screen p-3 flex justify-center">
            {type === "success" &&
                <div
                    className="flex items-center md:w-[30%] w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-xl dark:text-gray-400 dark:bg-gray-800"
                    role="alert">
                    <div
